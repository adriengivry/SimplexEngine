...
float SimplexEngine::Maths::Triangle2D::GetArea() const
{
...
SimplexEngine::Maths::Triangle2D::BoundingBox SimplexEngine::Maths::Triangle2D::GetBoundingBox() const
{
...
glm::vec3 SimplexEngine::Maths::Triangle2D::GetBarycentricCoordinates(const glm::vec2& p_point, uint8_t p_referenceVertex) const
{
