...
SimplexEngine::Scripts::SProfilerLogger::SProfilerLogger(SimplexEngine::Analytics::Profiler& p_profiler, const Core::InputManager& p_inputManager, Core::UserInterface& p_userInterface) :
