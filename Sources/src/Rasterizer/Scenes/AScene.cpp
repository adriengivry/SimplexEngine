...
Rasterizer::Scenes::AScene::AScene(Core::Window& p_window, Core::EventHandler& p_eventHandler, Core::InputManager& p_inputManager, Rendering::Renderer& p_renderer, Core::UserInterface& p_userInterface, Rendering::RasterBoy& p_rasterBoy, Analytics::Profiler& p_profiler, Utils::Clock& p_clock, Resources::Managers::MeshManager& p_meshManager) :
	m_window(p_window),
